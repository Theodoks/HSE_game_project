...
public class Level1 extends Level {
    ...
    public Level1(MyGdxGame mgg) {
        ...
        solids[58] = new GrassyPlat(  solids[0].x + 20*X, 730* Y);
        ...
        solids[59] = new GrassyPlat(  solids[0].x + 10*X, 970* Y);
        objects.add(solids[58]);
        objects.add(solids[59]);
        solids[60] = new GrassyPlat(  solids[0].x, 1200* Y);
        objects.add(solids[60]);
        solids[61] = new GrassyPlat(  solids[0].x - 5 * X, 1440* Y);
        objects.add(solids[61]);
        solids[64] = new GrassyPlat(  solids[0].x + 820 * X, 1440* Y);
